...
export default function TopicCard({
  ...
  return (
    <Link
      href={href}
      className={`group relative flex h-full flex-col overflow-hidden rounded-2xl border transition-all duration-500 ${className}
    ...
    >
      ...
      <div className="relative z-10 flex flex-1 flex-col justify-between p-6">
        ...
        {/* Footer Arrow */}
        <div className="mt-6 flex items-center gap-2 text-xs font-bold uppercase tracking-wider opacity-0 transition-all duration-300 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0"
