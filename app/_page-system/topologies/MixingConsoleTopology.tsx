    ...
    <div className="overflow-hidden rounded-[32px] border border-white/[0.08] bg-black/[0.14] shadow-[0_34px_110px_rgba(0,0,0,0.28)] backdrop-blur-xl">
      <div className="grid gap-4 border-b border-white/[0.07] p-5 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end sm:p-6">
        <div>
          ...
          <p className="mt-3 max-w-3xl text-[14px] leading-6 text-slate-400/72">
        ...
        <span className="font-mono text-[11px] uppercase tracking-[0.09em] text-slate-500/68">
            ...
            {channels.map((channel, index) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="mt-1.5 line-clamp-3 text-[11px] leading-4 text-slate-500/78">
                    {channel.question}
                  </span>
                </button>
              );
