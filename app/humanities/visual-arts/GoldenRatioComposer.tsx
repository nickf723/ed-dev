    ...
    <div className="overflow-hidden rounded-[24px] border border-white/[0.08] bg-[#0c0908]/80 shadow-[0_24px_85px_rgba(0,0,0,0.24)]">
      <div className="grid lg:grid-cols-[250px_minmax(0,1fr)]">
        <aside className="border-b border-white/[0.07] p-4 lg:border-b-0 lg:border-r sm:p-5">
          <div className="flex items-center gap-2 font-mono text-[8px] font-semibold uppercase tracking-[0.14em] text-orange-200/65"><LayoutTemplate size={12} /> Composition guides</div>
          <h3 className="mt-2 text-[18px] font-semibold text-white">Compare frameworks, not formulas.</h3>
          ...
          <div className="mt-5 rounded-[14px] border border-white/[0.06] bg-black/[0.18] p-3">
            <div className="font-mono text-[7px] uppercase tracking-[0.1em] text-stone-700">{NOTES[overlay].label}</div>
            <p className="mt-2 text-[8px] leading-4 text-stone-600">{NOTES[overlay].text}</p>
          </div>
        </aside>

        <div className="relative min-h-[440px] overflow-hidden bg-[radial-gradient(circle_at_25%_18%,rgba(244,63,94,0.18),transparent_35%),radial-gradient(circle_at_74%_72%,rgba(59,130,246,0.18),transparent_36%),linear-gradient(145deg,#171012,#09090c)]">
          ...
          <button
            ...
            className="absolute z-20 h-8 w-8 -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/60 bg-white/15 shadow-[0_0_24px_rgba(255,255,255,0.35)] backdrop-blur-sm"
          ...
          <div className="absolute inset-x-4 bottom-4 rounded-[13px] border border-white/[0.08] bg-black/35 px-4 py-3 backdrop-blur-md">
            <div className="flex items-center justify-between gap-4 font-mono text-[7px] uppercase tracking-[0.09em] text-white/45"><span>click the focal marker to move it</span><span>x {focalX} · y {focalY}</span></div>
          </div>
        </div>
      </div>
    </div>
