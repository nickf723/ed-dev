...
export default function EthicalReasoningExperience() {
    ...
    <main className="relative min-h-screen overflow-x-hidden bg-[#07070b] text-slate-100 selection:bg-amber-300/25">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1020px] px-4 pb-14 sm:px-6 lg:px-8">
        <div className="sticky top-0 z-30 -mx-4 border-b border-white/[0.07] bg-[#07070b]/80 px-4 pb-4 pt-5 backdrop-blur-2xl sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
          <DomainPageHeader
            breadcrumbs={[
              ...
              { label: "Ethics", href: "/humanities/philosophy/ethics" },
              { label: "Normative Ethics", href: "/humanities/philosophy/ethics/normative-ethics" },
              { label: "Ethical Reasoning" },
            ]}
            eyebrow="Normative Ethics · Reasons & arguments"
            icon={Scale}
            title={<span>Ethical Reasoning</span>}
            ...
            accentRgb={ACCENT}
            titleClassName="font-mono text-[clamp(2rem,4.7vw,4.1rem)] font-semibold uppercase leading-[0.9] tracking-[-0.05em] text-[#fffaf0]"
        ...
        <div className="mt-10 space-y-16">
          ...
          <nav className="flex flex-col gap-3 pb-10 sm:flex-row sm:justify-between" aria-label="Ethical reasoning navigation">
            <Link href="/humanities/philosophy/ethics/normative-ethics" className="inline-flex items-center gap-2 rounded-[18px] border border-white/[0.09] bg-black/[0.16] px-4 py-3 text-[13px] text-slate-300 transition hover:border-white/[0.16] hover:text-white"><ArrowLeft size={15} /> Normative Ethics map</Link>
            <Link href="/humanities/philosophy/ethics" className="rounded-[18px] border border-amber-200/[0.14] bg-amber-300/[0.04] px-4 py-3 text-right text-[13px] font-semibold text-amber-100 transition hover:bg-amber-300/[0.08]">Ethics map</Link>
          </nav>
        </div>
      </div>
    </main>
