...
import LessonVocabularyDrawer, { LessonVocabWord } from '@/app/_components/LessonVocabularyDrawer';
import { M } from '@/app/_components/Math';

const RADIOLOGY_VOCAB: LessonVocabWord[] = [
    {
        term: "Bremsstrahlung",
        category: "Physics",
...
export default function XRayPhysicsPage() {
    return (
        <main className="relative min-h-screen bg-[#030304] text-zinc-300 font-sans selection:bg-cyan-500/30 overflow-x-hidden">
            <XRayBackground />
            <LessonVocabularyDrawer vocabList={RADIOLOGY_VOCAB} themeColor="cyan" />
