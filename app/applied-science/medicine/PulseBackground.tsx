import { MEDICINE_REASONING_STAGES } from "./medicineModel";
...
export default function PulseBackground() {
  ...
  return (
    ...
    >
      ...
      <svg
        className="absolute inset-[11%_3%_12%_3%] h-[77%] w-[94%] opacity-90"
      ...
      >
        ...
        <g transform="translate(360 160)">
          <text
            x="0"
            y="0"
            fill="rgba(153,246,228,0.28)"
            fontSize="13"
            fontFamily="monospace"
          >
            CASE TIMELINE · SYNTHETIC TEACHING RECORD
          </text>
          <line
            x1="0"
            y1="78"
          ...
          <g transform="translate(20 156)">
            ...
            <path
              d="M0 68 C70 62 112 73 170 66 S283 49 350 59 S473 75 545 61 S680 46 790 56"
              fill="none"
              stroke="rgba(248,113,113,0.24)"
              strokeWidth="2"
            />
            <path
              d="M0 104 C92 93 144 112 232 100 S389 86 477 97 S626 110 790 92"
              fill="none"
              stroke="rgba(125,211,252,0.19)"
              strokeWidth="2"
            />
            <line
              x1="0"
          ...
          <g transform="translate(20 340)">
            <text
              ...
              fontFamily="monospace"
            >
              ORDERS / INTERVENTIONS / FOLLOW-UP
            </text>
            {[0, 1, 2, 3].map((row) => (
        ...
        <g transform="translate(85 200)">
          ...
          />
          <path
            d="M99 45v116M69 76c18 14 43 14 60 0M70 130c18-13 41-13 59 0"
            fill="none"
            stroke="rgba(125,211,252,0.12)"
          />
          <rect
          ...
          />
          <path
            d="M28 260h22l9-18 16 43 15-31 13 13h67"
            fill="none"
            stroke="rgba(244,114,182,0.19)"
            strokeWidth="2"
          />
        </g>
        ...
        <g transform="translate(1140 230)">
          ...
          {MEDICINE_REASONING_STAGES.map((stage, index) => (
            <g key={stage.key} transform={`translate(0 ${index * 62 + 28})`}>
              <rect
                width="130"
                height="34"
                rx="17"
              ...
              {index < 4 ? (
                <path d="M65 36v22" stroke="rgba(251,191,36,0.12)" />
              ) : null}
            </g>
          ))}
          <path
            d="M0 318c-44 0-44-286 0-286"
            fill="none"
        ...
        <rect
          ...
          className="animate-[chart-review_48s_ease-in-out_infinite_alternate] motion-reduce:animate-none"
        />
      </svg>

      <style>{`@keyframes chart-review { from { transform: translateX(0); } to { transform: translateX(820px); } }`}</style>
      <div className="via-[#07100f]/78 absolute inset-x-0 top-0 h-[19%] bg-gradient-to-b from-[#07100f] to-transparent" />
      <div className="via-[#07100f]/82 absolute inset-x-0 bottom-0 h-[21%] bg-gradient-to-t from-[#07100f] to-transparent" />
