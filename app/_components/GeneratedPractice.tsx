...
export default function GeneratedPractice({
  ...
  const [question, setQuestion] = useState<GeneratedPracticeQuestion | null>(null);
  ...
  const isCorrect = Boolean(question && selected === question.correctAnswer);
  ...
  return (
    ...
    >
      ...
      {!question ? (
        <div className="mt-4 rounded-[18px] border border-white/[0.05] bg-[#06111e]/72 px-4 py-8 text-center text-[11px] text-slate-600">
          Preparing a problem…
        </div>
      ) : (
