...
import { Search, FileText, Hash, Gamepad2, BookOpen, X, FlaskConical, LayoutGrid } from "lucide-react";
import { glossaryTerms } from "@/lib/glossary-db";

// --- INDEXING ---
// Updated to reflect the Nexus OS structure
const PAGES = [
  // 1. SYSTEM APPS
  { title: "Home Dashboard", href: "/", icon: LayoutGrid, type: "System" },
  { title: "The Library", href: "/library", icon: BookOpen, type: "App" },
  { title: "The Arcade", href: "/arcade", icon: Gamepad2, type: "App" },
  { title: "The Lab", href: "/dev-playground", icon: FlaskConical, type: "App" },

  // 2. KNOWLEDGE SECTORS
  { title: "Formal Science", href: "/formal-science", icon: Hash, type: "Sector" },
  { title: "Natural Science", href: "/natural-science", icon: FileText, type: "Sector" },
  { title: "Social Science", href: "/social-science", icon: FileText, type: "Sector" },
  { title: "Applied Science", href: "/applied-science", icon: FileText, type: "Sector" },
  { title: "Humanities", href: "/humanities", icon: BookOpen, type: "Sector" },
  { title: "Interdisciplines", href: "/interdisciplines", icon: FileText, type: "Sector" },

  // 3. SPECIFIC EXPERIENCES (Deep Links)
  { title: "Magic: The Gathering", href: "/interdisciplines/game-studies/library/magic-the-gathering", icon: Gamepad2, type: "Sim" },
  { title: "Game Studies", href: "/interdisciplines/game-studies", icon: Gamepad2, type: "Module" },
];
          ...
          >
            ...
            <div className="max-h-[60vh] overflow-y-auto p-2">
                ...
                {filteredPages.length > 0 && (
                    <div className="mb-4">
                        <span className="px-3 text-[10px] font-bold uppercase text-neutral-500 mb-2 block">System & Navigation</span>
                ...
                {filteredTerms.length > 0 && (
                    <div>
                        <span className="px-3 text-[10px] font-bold uppercase text-neutral-500 mb-2 block">Glossary Definitions</span>
                        {filteredTerms.map((term) => (
                            <button
                                key={term}
                                onClick={() => handleSelect(`/glossary#${term}`)}
                                className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-white/10 text-neutral-300 hover:text-white transition-colors group"
                            >
