...
export const biologyVocab: VocabTerm[] = [
  {
    ...
    word: "Homeostasis",
    definition:
      "The state of steady internal, physical, and chemical conditions maintained by living systems, regardless of external environmental changes.",
    domain: "Biology",
  ...
  },
  {
    ...
    word: "Mitosis",
    definition:
      "A part of the cell cycle in which replicated chromosomes are separated into two new nuclei, resulting in genetically identical daughter cells.",
    domain: "Biology",
