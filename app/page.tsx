...
export default function Home() {
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-[#02040a] text-slate-100 selection:bg-cyan-400/30 lg:h-screen lg:overflow-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 z-0 bg-[radial-gradient(circle_at_50%_48%,rgba(255,255,255,0.015),transparent_28%),linear-gradient(to_bottom,rgba(2,4,10,0.10),rgba(2,4,10,0.52))]" />

      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-[1500px] flex-col px-4 py-6 sm:px-6 lg:h-screen lg:min-h-0 lg:px-8 lg:py-8">
