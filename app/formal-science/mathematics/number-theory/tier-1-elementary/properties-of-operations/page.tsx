// app/formal-science/mathematics/number-theory/tier-1-elementary/properties-of-operations/page.tsx
"use client";
...
export default function AlgebraicPropertiesPage() {
  return (
    <main className="topic-page theme-number-theory lg:px-16"> {/* THEME UPDATED */ }
      ...
      <PageHeader
        eyebrow="Tier 1: Elementary Number Theory" // EYEBROW UPDATED
        title="Properties of Operations (1.2)" // TITLE UPDATED
        subtitle="The fundamental rules that govern how we manipulate, combine, and simplify numbers. Mastering these is the key to both arithmetic and algebra."
      />
        ...
        <div className="lg:col-span-2 text-left">
          ...
          <CollapsibleTopic title="2. Identity & Inverse Properties" icon={Sigma}>
            <ContentP>
              ...
              "cancel out" — two crucial concepts for solving equations.
            </ContentP>
    ...
    <div className="glass rounded-2xl border border-neutral-800/60 p-6">
      ...
      <ul className="space-y-3">
        ...
        <AsideLink
          ...
          description="See how these properties are used to simplify algebra."
        />
        <AsideLink
