...
const topics = [
  {
    ...
    href: "/formal-science/mathematics/number-theory/undergraduate/euclidean-structure",
    Icon: GitMerge,
    desc: "Euclidean algorithm, Bézout’s identity, and modular inverses.",
    className: "theme-number-theory",
  },
  {
    title: "Congruence Classes Algebra",
    href: "/formal-science/mathematics/number-theory/undergraduate/congruence-classes-algebra",
    Icon: Network,
  ...
  },
  {
    ...
    href: "/formal-science/mathematics/number-theory/undergraduate/multiplicative-number-theory",
    Icon: Sigma,
  ...
  },
  {
    ...
    href: "/formal-science/mathematics/number-theory/undergraduate/quadratic-residues",
    Icon: Waves,
    desc: "Legendre symbol and an introduction to quadratic reciprocity.",
    className: "theme-number-theory",
  },
  {
    title: "Prime Distribution Theory",
    href: "/formal-science/mathematics/number-theory/undergraduate/prime-distribution-theory",
    Icon: Waves,
  ...
  return (
    <main className="topic-page theme-number-theory lg:px-16">
      ...
      <PageHeader
        ...
        title="Undergraduate Number Theory"
