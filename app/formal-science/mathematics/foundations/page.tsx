...
const FOUNDATION_PRESENTATION: Record<string, FoundationPresentation> = {
                  ...
                  <div className="flex items-center gap-6 relative z-10 w-full">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-1">
                        ...
                        <h2 className="text-xl font-bold text-white group-hover:text-rose-100 transition-colors">{topic.label}</h2>
                      </div>
