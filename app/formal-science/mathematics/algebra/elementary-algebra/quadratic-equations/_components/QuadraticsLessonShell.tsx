...
export type QuadraticsLessonNavItem = {
  label: string;
  href: string;
};
...
export default function QuadraticsLessonShell({
  breadcrumbs,
  previous,
  next,
  unitHref,
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden text-slate-100" style={{ backgroundColor: base }}>
      ...
      <div
        ...
        style={{
          background: `radial-gradient(circle at 78% 12%, rgba(${accentRgb},0.13), transparent 28%), radial-gradient(circle at 15% 82%, rgba(${accentRgb},0.055), transparent 30%), linear-gradient(to bottom, rgba(2,6,23,0.18), rgba(2,5,12,0.92))`,
        }}
      />
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1380px] px-4 py-4 sm:px-6 xl:px-8 xl:py-5">
        ...
        <section id={practiceId} className="scroll-mt-24 mt-4">
          <details className="group overflow-hidden rounded-[22px] border border-white/[0.09] bg-black/[0.18] backdrop-blur-2xl">
            ...
            <div className="quadratics-assessment border-t border-white/[0.06] p-3 sm:p-4">
      ...
      <style>{`
        .quadratics-assessment > div { border-radius: 18px !important; padding: 16px !important; background: rgba(0,0,0,0.10) !important; box-shadow: none !important; }
        .quadratics-assessment > div > div { min-height: 300px !important; }
        .quadratics-assessment h3 { margin-bottom: 16px !important; font-size: 1.05rem !important; line-height: 1.45 !important; }
        .quadratics-assessment button { padding-top: 10px !important; padding-bottom: 10px !important; }
      `}</style>
    </main>
  );
}
...
function LessonNavigation({
  ...
  return (
    <nav className="mt-4 pb-8" aria-label="Quadratic Equations lesson navigation">
      <div className="mb-2 flex justify-end">
        <span className="font-mono text-[10px] text-slate-700">{currentStep} / 05</span>
      </div>
        ...
        {next ? (
          ...
          >
            <span className="min-w-0 flex-1 text-right">
              ...
              <strong className="mt-1 block text-[14px] text-slate-200">Return to Quadratic Equations</strong>
            </span>
