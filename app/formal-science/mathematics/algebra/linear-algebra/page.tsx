...
function buildMatrixElements() {
  const linearAlgebra = curriculumRegistry.getNode("formal.mathematics.algebra.linear-algebra");
  if (!linearAlgebra) throw new Error("Linear Algebra is missing from the curriculum registry.");

  return (linearAlgebra.children ?? []).map((module) => {
...
const MATRIX_ELEMENTS = buildMatrixElements();
