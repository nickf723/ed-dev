...
import { 
  ...
  Layers, Expand, CheckCircle2, ArrowRight, Shield
} from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-24">
            ...
            <div className="p-8 bg-slate-900/60 border border-white/5 rounded-2xl backdrop-blur-md shadow-xl flex flex-col gap-8">
              ...
              <div>
                  ...
                  <p className="text-sm text-slate-400 leading-relaxed mb-4">
                      The word "commute" means to move around. This property says you can <strong>swap the order</strong> of numbers and get the same answer.
                  </p>
              ...
              <div>
                  ...
                  <p className="text-sm text-slate-400 leading-relaxed mb-4">
                      Who you "associate" with means who you group with. This property lets you <strong>move the parentheses</strong> to group numbers differently.
                  </p>
                  <div className="bg-black/50 p-4 rounded-xl border border-white/5 font-mono text-center text-lg">
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="relative">
                ...
                {/* Visual Description above the lab */}
                <div className="mb-8 pt-2">
                    <h3 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">
                        The Distributive Property
                    </h3>
                    <p className="text-sm text-slate-400 leading-relaxed">
                        This is arguably the most powerful tool in Algebra. To multiply a number by a group, you must "distribute" that multiplier to <strong>every single item</strong> inside the parentheses. Use the Area Model below to prove why this works!
                    </p>
                </div>
        ...
        <section className="mt-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="col-span-1 lg:col-span-2">
                    <Assessment 
                        title="Knowledge Check: Properties of Math" 
        ...
        <div className="mt-24 pt-12 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-zinc-400 text-sm font-light">You know the laws of mathematical motion.</p>
                </div>
            </div>
