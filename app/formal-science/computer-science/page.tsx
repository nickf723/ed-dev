    ...
    <main className="p-8 md:p-12 min-h-screen space-y-12 animate-in fade-in duration-500 font-mono">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <DashboardCard
          ...
          className="bg-black/60"
        >
          <div className="mt-auto text-xs text-purple-300">O(n log n) Efficiency</div>
        </DashboardCard>
        ...
        <DashboardCard
          ...
          className="bg-black/60"
        >
          <div className="mt-auto text-xs text-slate-400">Automata • Turing Machines • Complexity</div>
        </DashboardCard>
