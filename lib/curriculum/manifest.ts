...
import { CALCULUS_CURRICULUM } from "@/lib/curriculum/calculus";
...
import { LIMITS_CURRICULUM } from "@/lib/curriculum/limits";
...
import { GAME_STUDIES_CURRICULUM } from "@/lib/curriculum/interdisciplines/game-studies";
...
export const CURRICULUM_MODULES: readonly CurriculumNode[] = [
  ...
  SECURITY_CRYPTOGRAPHY_CURRICULUM,
