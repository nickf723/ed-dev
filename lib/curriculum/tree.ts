...
export const CURRICULUM_DOMAINS = [
  {
    ...
    children: [
      node("formal.mathematics", "Mathematics", "/formal-science/mathematics", "formal", [
        ...
        node("formal.mathematics.abstract-algebra", "Abstract Algebra", "/formal-science/mathematics/algebra/abstract-algebra", "formal", [
          node("formal.mathematics.abstract-algebra.field-theory", "Field Theory", "/formal-science/mathematics/algebra/abstract-algebra/field-theory", "formal"),
        ]),
      ]),
