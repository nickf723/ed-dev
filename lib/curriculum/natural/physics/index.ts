  ...
  [
    ...
    node(
      ...
      [
        ...
        node("natural.physics.thermodynamics.phase-change", "Phase Change", "/natural-science/physics/thermodynamics/phase-change", "Explain why energy can change phase without changing temperature and connect latent heat to microscopic structure.", undefined, "placeholder"),
        node("natural.physics.thermodynamics.entropy", "Entropy & Second Law", "/natural-science/physics/thermodynamics/entropy", "Interpret entropy through multiplicity, energy dispersal, and the direction of spontaneous processes rather than as vague disorder.", undefined, "placeholder"),
        node("natural.physics.thermodynamics.processes", "Thermodynamic Processes", "/natural-science/physics/thermodynamics/processes", "Read pressure-volume processes, cycles, and heat engines as constrained paths through thermodynamic state space.", undefined, "placeholder"),
      ],
    ),
