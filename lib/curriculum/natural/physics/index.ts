...
export const PHYSICS_CURRICULUM: CurriculumNode = node(
  ...
  [
    ...
    node(
      ...
      "Temperature, heat, internal energy, entropy, equilibrium, and the direction of macroscopic physical processes.",
      [
        node("natural.physics.thermodynamics.temperature", "Temperature & Equilibrium", "/natural-science/physics/thermodynamics/temperature-equilibrium", "Connect temperature to microscopic energy distributions and understand thermal equilibrium through the zeroth law."),
        node("natural.physics.thermodynamics.heat-transfer", "Heat Transfer", "/natural-science/physics/thermodynamics/heat-transfer", "Distinguish heat from temperature and model conduction, convection, and radiation as energy-transfer mechanisms."),
        node("natural.physics.thermodynamics.first-law", "Internal Energy & First Law", "/natural-science/physics/thermodynamics/first-law", "Track changes in internal energy through heat transfer and work using a consistent system-boundary convention."),
        node("natural.physics.thermodynamics.phase-change", "Phase Change", "/natural-science/physics/thermodynamics/phase-change", "Explain why energy can change phase without changing temperature and connect latent heat to microscopic structure."),
        node("natural.physics.thermodynamics.entropy", "Entropy & Second Law", "/natural-science/physics/thermodynamics/entropy", "Interpret entropy through multiplicity, energy dispersal, and the direction of spontaneous processes rather than as vague disorder."),
        node("natural.physics.thermodynamics.processes", "Thermodynamic Processes", "/natural-science/physics/thermodynamics/processes", "Read pressure-volume processes, cycles, and heat engines as constrained paths through thermodynamic state space."),
      ],
    ),
    node(
      ...
      "Charge, electric and magnetic fields, potential, circuits, induction, and electromagnetic radiation.",
      [
        node("natural.physics.electromagnetism.charge-fields", "Charge & Electric Fields", "/natural-science/physics/electromagnetism/charge-fields", "Build electric fields from charge, read field direction and strength, and connect fields to electric force."),
        node("natural.physics.electromagnetism.potential", "Electric Potential", "/natural-science/physics/electromagnetism/electric-potential", "Interpret electric potential and voltage as energy-per-charge and connect equipotentials to electric fields.", undefined, "placeholder"),
        node("natural.physics.electromagnetism.circuits", "Circuits", "/natural-science/physics/electromagnetism/circuits", "Model current, voltage, resistance, power, and energy transfer in simple electric circuits.", undefined, "placeholder"),
        node("natural.physics.electromagnetism.magnetic-fields", "Magnetic Fields", "/natural-science/physics/electromagnetism/magnetic-fields", "Connect moving charge and current to magnetic fields and model magnetic force on charges and wires.", undefined, "placeholder"),
        node("natural.physics.electromagnetism.induction", "Electromagnetic Induction", "/natural-science/physics/electromagnetism/induction", "Relate changing magnetic flux to induced electric fields and emf through Faraday's law.", undefined, "placeholder"),
        node("natural.physics.electromagnetism.waves", "Electromagnetic Waves", "/natural-science/physics/electromagnetism/electromagnetic-waves", "Understand light and other electromagnetic radiation as self-propagating coupled electric and magnetic fields.", undefined, "placeholder"),
      ],
    ),
