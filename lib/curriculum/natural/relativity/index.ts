...
export const RELATIVITY_CURRICULUM: CurriculumNode = node(
  ...
  [
    node(
      ...
      [
        node("natural.physics.relativity.special.frames", "Frames & Postulates", "/natural-science/physics/relativity/special/frames-postulates", "Establish inertial frames and the two postulates that force classical space and time to be revised.", undefined, "placeholder"),
        node("natural.physics.relativity.special.simultaneity", "Relativity of Simultaneity", "/natural-science/physics/relativity/special/simultaneity", "Show why spatially separated events that are simultaneous in one inertial frame need not be simultaneous in another.", undefined, "placeholder"),
