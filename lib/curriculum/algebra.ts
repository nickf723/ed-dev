...
const fundamentalsLessons = [
  ...
  node(
    ...
    "/formal-science/mathematics/algebra/elementary-algebra/fundamentals/one-step-equations",
    "Use inverse operations to isolate a variable when a single operation stands between it and its solution.",
    undefined,
    "active",
    "lesson",
  ),
  node(
    ...
    "/formal-science/mathematics/algebra/elementary-algebra/fundamentals/two-step-equations",
    "Solve equations such as ax + b = c by undoing one operation at a time while preserving equality.",
    undefined,
    "active",
    "lesson",
  ),
