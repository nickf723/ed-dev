...
export const NYS_ALGEBRA_I_COURSE: Course = {
  ...
  description:
    "Build from expressions and equations into functions, systems, polynomials, quadratics, and data.",
  ...
  plannedUnits: [
    {
      ...
      summary: "Represent constant rates with equations, tables, graphs, and inequalities.",
    },
    {
      id: "nys.algebra-1.unit-3",
      slug: "unit-3",
      number: 3,
      title: "Functions",
      summary: "Connect inputs, outputs, notation, domain, range, and multiple representations.",
    },
    {
      id: "nys.algebra-1.unit-4",
      slug: "unit-4",
      number: 4,
      title: "Systems & Inequalities",
      summary: "Use shared solutions and feasible regions to satisfy several constraints at once.",
    },
    {
      id: "nys.algebra-1.unit-5",
      slug: "unit-5",
      number: 5,
      title: "Exponents & Polynomials",
      summary: "Model repeated multiplication and operate on polynomial expressions.",
    },
    {
      id: "nys.algebra-1.unit-6",
      slug: "unit-6",
      number: 6,
      title: "Quadratic Functions",
      summary: "Connect factored, standard, and vertex forms to roots, shape, and change.",
    },
    {
      id: "nys.algebra-1.unit-7",
      slug: "unit-7",
      number: 7,
      title: "Data & Modeling",
      summary: "Describe variation, fit models, inspect residuals, and interpret predictions.",
    },
  ],
};
