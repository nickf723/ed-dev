...
The next contrasting target is Social Science → Political Science. Audit whether its root distinguishes institutions, behavior, public policy, comparative systems, international relations, theory, and methods without turning political positions into decorative teams. Preserve useful existing models, establish exact curriculum and vocabulary ownership, and choose a civic or institutional visual grammar unlike Astronomy's light-cone observatory.
