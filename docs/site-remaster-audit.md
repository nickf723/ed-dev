...
The next contrasting target is Applied Science → Medicine. Audit whether its root distinguishes clinical reasoning, diagnosis, therapeutics, pathology, prevention, specialties, evidence, and care systems without turning the body into decorative anatomy or presenting a simulator as medical advice. Preserve the active Anatomy & Physiology child, establish exact curriculum and vocabulary ownership, and choose a clinical visual grammar unlike Political Science's civic chamber.
