...
Education completes the Applied Science learning-design pass without reducing the field to classroom technique, a universal stage theory, or one teaching-method score. Nine planned direct branches remain registry-owned and inert inside three overlapping work folios. The preserved alignment studio now reads from one tested goal/activity/evidence model; a four-case conference tests alignment, feedback, reliability/validity, and access. Twenty-eight narrowly owned terms aggregate into Applied Science. The learning-evidence wall is now static, while WWC, NCES CCD, CAST UDL, and IDEA links establish research-review, descriptive-data, design-guidance, legal-source, and no-render-fetch boundaries.

Biology completes the Natural Science living-scale pass without reducing life to DNA iconography, a decorative phylogenetic tree, or one taxonomic catalog. Ten direct registry branches remain authoritative; four analytical scale bands cover every non-Evolution branch exactly once while Evolution stays cross-scale. The preserved scale atlas now leads into a four-specimen magnification bench and four-file evidence review. Forty-eight unique terms aggregate through narrow Biology, Botany, and Zoology ownership. A static molecular-to-ecological field replaces the viewport animation canvas, while NCBI Taxonomy, GBIF occurrence, and Open Tree of Life links establish identity-, evidence-, release-, license-, uncertainty-, and citation-aware repository boundaries without a render-time fetch.

Anthropology completes the Social Science four-field evidence pass without treating cultures as specimens, human evolution as a ladder, human variation as fixed racial types, or collection access as permission. Cultural, Biological, Archaeological, and Linguistic Anthropology remain registry-owned peers; Archaeology is active and three planned fields remain inert. The preserved hominin viewer and shared-meal synthesis now lead into a tested 18/48 observation-share fixture and four-file evidence review. Eighteen terms aggregate into Social Science through narrow field ownership. A static field record replaces the cave animation, while AAA ethics, Smithsonian Open Access, and National NAGPRA links establish consent-, harm-, rights-, provenance-, consultation-, repatriation-, and no-display-aware collection boundaries without a render-time fetch.

Computer Science completes the Formal Science execution pass without reducing the field to a generic neon terminal. Six direct active branches remain registry-owned; the shared stack and Represent → Transform → Execute → Communicate loop now lead into a four-case trace review. A deterministic execution field replaces the root canvas, eighteen narrowly owned terms aggregate into Formal Science, and GitHub, RFC Editor, and NVD boundaries distinguish repositories, standards, and vulnerability records.

Religion completes the contrasting Humanities interpretation pass without reducing traditions to belief checklists or treating technical access as interpretive authority. Eight direct fields remain registry-owned; Mythology is active and seven planned peers remain inert. The preserved comparative fieldnote instrument now leads into a four-case evidence review and explicit AAR, Library of Congress, and Met boundaries. A deterministic comparative reading table replaces the root canvas, and twenty-six terms aggregate into Humanities.

Astronomy completes the Natural Science lookback pass without confusing physical scale, observing method, distance, elapsed signal time, or model-dependent inference. Five scale branches and one cross-cutting Methods branch remain registry-owned; Planetary is the only active child, and the prior dead Cosmology link is repaired. The preserved signal and lookback instruments now lead into a tested redshift/evidence review. A deterministic light-cone field replaces the root canvas, twenty-four narrowly owned terms aggregate into Natural Science, and MAST, GWOSC, and NASA ADS boundaries keep observation products, event parameters, and literature records distinct.

Political Science completes the Social Science institutional pass without reducing the field to elections, ideology, or partisan territory. Eight direct planned branches remain registry-owned and appear before the lesson in responsive analytical bands. The preserved 125-seat coalition instrument now shares its exact party and hemicycle model with a deterministic civic-chamber background. A four-case review distinguishes possible majorities from plausible governments, vote share from seat share, sequence from cause, and adoption from implementation and effect. Twenty-two narrowly owned terms aggregate into Social Science, while Congress.gov, World Bank Indicators, and V-Dem boundaries keep official records, cross-national series, modeled estimates, and causal claims distinct.

Medicine completes the Applied Science clinical-reasoning pass without turning the body into decorative anatomy or a fictional simulator into medical advice. Ten direct fields remain registry-owned; Anatomy & Physiology is active and nine planned peers remain inert. The preserved evidence-packet lab now shares its five-stage loop and exact weights with a tested model, while a four-case review teaches sensitivity, positive predictive value, record-type boundaries, and follow-up. Thirty-nine narrowly owned terms aggregate through Medicine into Applied Science, while ClinicalTrials.gov, openFDA label, and NCBI literature boundaries keep registration, submitted labels, bibliographic records, evidence synthesis, regulatory decisions, and clinical recommendations distinct.

Languages completes the Humanities communicative-practice pass without collapsing languages into flags, tourist phrases, word-for-word substitution, or one proficiency percentage. Eight direct planned fields remain registry-owned and appear before the lesson in two responsive folios. The preserved phrase and translation instruments now share their fixed data with a tested model and a four-case review spanning exact sample arithmetic, communicative equivalence, signed-language modality, and provider-record boundaries. Twenty-two narrowly owned terms aggregate into Humanities, while Glottolog, Unicode CLDR, and OLAC boundaries keep catalog classification, software locale data, archive metadata, content access, community knowledge, and rights distinct.

The next contrasting target is Formal Science → Logic. Audit whether its root clearly separates propositional, first-order, proof, informal, modal, computational, and philosophical questions without reducing logic to symbolic wallpaper or one truth-table widget. Preserve useful proof and reasoning systems, establish exact curriculum and vocabulary ownership, and choose a rule-governed visual grammar unlike Languages' editorial desk.
