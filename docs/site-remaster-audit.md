...
The next contrasting target is Formal Science → Data Science. Audit its current child ontology, data-source potential, model claims, vocabulary ownership, assessment contract, and whether its visual language represents uncertainty and evidence rather than importing the gallery or living-field grammar of the previous passes.
