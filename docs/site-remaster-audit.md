...
The next contrasting target is Humanities → Visual Arts. Preserve any successful pigment, gallery, or making-oriented interactions while auditing its bounded learning contract, collection potential, vocabulary ownership, and whether a museum collection API can add real works with honest image rights and provenance.
