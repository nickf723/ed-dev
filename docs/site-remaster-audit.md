...
The next contrasting target is Humanities → Languages. Audit whether its root represents language learning, linguistics-informed structure, script and sound, usage, literature, translation, and cultural context without collapsing languages into flags, tourist phrases, or one proficiency ladder. Preserve useful practice systems, establish exact curriculum and vocabulary ownership, and choose a communicative visual grammar unlike Medicine's clinical record.
