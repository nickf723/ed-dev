...
The next contrasting target is Natural Science → Physics. Audit its root ontology, existing active mechanics and other descendants, mathematical practice, measurement boundaries, vocabulary ownership, and instrument opportunities without importing Sociology's scale bands as the page's visual shell.
