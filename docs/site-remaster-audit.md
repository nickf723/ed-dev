...
The next contrasting target is Natural Science → Biology. Audit its root ontology, preserve any strong organismal or cellular interactives, reconcile active Botany and Zoology descendants, and establish one tested evidence model without importing Education's folios or Philosophy's argument grammar. Its visual world should communicate nested living organization, exchange, inheritance, variation, and ecological connection without falling back to a random glowing network.
