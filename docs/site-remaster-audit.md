...
The next contrasting target is Natural Science → Earth Science. Audit its systems ontology, live descendants, temporal and spatial scales, evidence models, collection opportunities, and whether its current environment distinguishes field observation from generic planetary scenery.
