...
The next contrasting target is Formal Science → Information Science. Audit its ontology, live taxonomy/ontology descendant, information lifecycle, retrieval and representation models, vocabulary ownership, and opportunities for a provenance-aware reference collection without importing Earth Science's field transect.
