...
The next contrasting target is Humanities → History. Audit its periodization, geography, source criticism, chronology, vocabulary ownership, and collection opportunities without importing Information Science's record inspector as the page's visual shell.
