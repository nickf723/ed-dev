...
The next contrasting target is Humanities → Philosophy. Audit its direct branches, argument and concept-modeling strengths, lesson flow, assessment depth, vocabulary ownership, and source/repository opportunities without importing Physics' instrument sheet or treating positions as decorative teams.
