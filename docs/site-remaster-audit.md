...
The next contrasting target is Applied Science → Agriculture. Audit its system boundaries, scales, seasonal cycles, production decisions, environmental feedback, vocabulary ownership, and truthful public-data opportunities without importing History's archival reading room as the page's visual shell.
