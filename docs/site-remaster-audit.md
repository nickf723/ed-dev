...
The next contrasting target is Social Science → Economics. Audit its existing child ontology, model assumptions, money/market visual language, vocabulary ownership, and whether any simulation separates accounting identities, behavioral responses, institutions, distribution, and causal claims. Preserve accurate interactives while avoiding the test-bench and analytical-dashboard grammar of the two preceding passes.
