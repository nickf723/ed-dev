...
The next contrasting target is Humanities → Music. Audit its existing branch ontology, notation and sound models, vocabulary ownership, recordings repository, and whether listening, performance, acoustics, theory, and cultural context remain legible as different evidence systems. Preserve successful audio and collection interactions while avoiding Chemistry's laboratory-bench grammar.
