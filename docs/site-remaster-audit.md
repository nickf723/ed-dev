...
The next contrasting target is Social Science → Anthropology. Audit whether its current root distinguishes biological, archaeological, linguistic, and sociocultural evidence without treating cultures as specimens or human variation as fixed racial typology. Preserve strong fieldwork or material-culture instruments, derive navigation and vocabulary from the registry, and establish one tested evidence model in a visual grammar unlike Biology's scale atlas.
