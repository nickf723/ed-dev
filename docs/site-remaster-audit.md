...
The next contrasting target is Social Science → Sociology. Audit its scale changes, institutions, networks, stratification, demographic evidence, vocabulary ownership, and public-data opportunities without importing Agriculture's farm-system transect as the page's visual shell.
