...
- Outsiders & Exchange uses the shared Leaflet/Natural Earth map infrastructure rather than hand-drawn land blobs; Tokugawa, Qing, and Atlantic selections fit their verified port/waypoint coordinates, update the named route layer, and preserve the route-does-not-prove-freedom/volume/control boundary
